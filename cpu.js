...
class ChunLiCPU extends ChunLi{
    ...
    update(){
        ...
        //Ground Physics
        if(this.CPUSTATE.AIR === false  && this.CPUSTATE.DEATH !== true){
            this.midpoint = this.x + (this.idle[this.animations[0][0].currentFrame()].w * PARAMS.CHUNLI);
            this.otherMidpoint = this.other.cX;
            this.position = this.otherMidpoint - this.midpoint;
            //Have to check what side of the map he is on. 
        ...
        this.game.entities.forEach(function (entity) {
                if (that !== entity && entity.BB && that.BB.collide(entity.BB)) {
                    ...
                    if((entity instanceof KaratePlayer || entity instanceof catplayer || entity instanceof ChunLi || entity instanceof BillyLee 
                        || entity instanceof Goku) && that.lastBB.right >= entity.BB.left && that.position > 0){
                            if(that.CPUSTATE.TRAVEL){
                                if(that.state === 1)that.x = entity.BB.left - that.idle[that.animations[0][0].currentFrame()].w * PARAMS.CHUNLI;
        ...
        this.cX = this.x + this.idle[this.animations[0][0].currentFrame()].w / 2 * PARAMS.CHUNLI;
        this.cY = this.y + this.idle[this.animations[0][0].currentFrame()].h / 2 * PARAMS.CHUNLI;
        opponentcX = this.cX;
        opponentcY = this.cY;
        this.updateBB();
        this.collisionsCPU();
...
=======
>>>>>>> 33449e06b4b3b81fa6e64c989fd1dc8717ee31a2
                        //Falling Logic - Level1 - Level2 - Ground
                        if((entity instanceof BackGround || entity instanceof BackScene || entity instanceof Sky) && that.lastBB.bottom >= entity.BB.bottom){
                            if(that.CPUSTATE.AIR === true){
                                that.state = 0; 
...
>>>>>>> 33449e06b4b3b81fa6e64c989fd1dc8717ee31a2
                        ...
                        if((entity instanceof KaratePlayer || entity instanceof catplayer || entity instanceof ChunLi || entity instanceof BillyLee
                            || entity instanceof Goku) && that.lastBB.left <= entity.BB.right){
                                ...
                                else if(that.state === 1) that.x = entity.BB.right;
                                else if(that.state === 2) that.x = entity.BB.right;
                                else if(that.state === 3) that.x = entity.BB.right;
                                else if(that.state === 4) that.x = entity.BB.right;
                                else if(that.state === 5) that.x = entity.BB.right;
                                else if(that.state === 6) that.x = entity.BB.right;
                                else if(that.state === 7) that.x = entity.BB.right;
                                else if(that.state === 8) that.x = entity.BB.right;
                                else if(that.state === 9) that.x = entity.BB.right;
                                else if(that.state === 10) that.x = entity.BB.right; 
                        }
                    }
                    //Air Collisions
                    if(that.velocity.y < 0){
                        //Jumping logic - Level2 - Platform
                        if((entity instanceof Platform) && that.lastBB.top >= entity.BB.bottom){
                            if(that.CPUSTATE.AIR) that.y = entity.BB.bottom + that.jump[that.animations[2][0].currentFrame()].h * PARAMS.CHUNLI;
                            else if(that.state === 4) that.y = entity.BB.bottom + that.kick[that.animations[4][0].currentFrame()].h * PARAMS.CHUNLI;
                            that.velocity.y = 0;
                            that.updateBB();
                        }
                        ...
                        //Jumping & Kicking to Right - Level2 - Level1
                        if((entity instanceof BackScene || entity instanceof BackGround || entity instanceof Sky) && that.lastBB.right >= entity.BB.right){
                            if(that.CPUSTATE.AIR) that.x = (entity.BB.right - (that.jump[that.animations[2][0].currentFrame()].w * PARAMS.CHUNLI));
                            that.updateBB();
                        }
                        //Jumping & Kicking to Left - Level2 - Level1
                        if((entity instanceof BackScene || entity instanceof BackGround || entity instanceof Sky) && that.lastBB.left <= entity.BB.left){
                        ...
                        if((entity instanceof KaratePlayer || entity instanceof catplayer || entity instanceof ChunLi || entity instanceof BillyLee
                            || entity instanceof Goku) && that.lastBB.right >= entity.BB.left){
                            if(that.CPUSTATE.AIR)that.state = 2;
                        }
                        if((entity instanceof KaratePlayer || entity instanceof catplayer || entity instanceof ChunLi || entity instanceof BillyLee
                            || entity instanceof Goku) && that.lastBB.left <= entity.BB.right){
                                if(that.CPUSTATE.AIR)that.state = 2;
...
//                         || entity instanceof Goku) && that.lastBB.right >= entity.BB.left && that.position > 0){
//                             if(that.CPUSTATE.TRAVEL){
//                                 if(that.state === 1) that.x = entity.BB.left - that.idle[that.animations[1][0].currentFrame()].w * PARAMS.CHUNLI;
//                             }
//                             if(that.CPUSTATE.ATTACK){
//                                 if(that.state === 3) that.x = entity.BB.left - that.punch[that.animations[3][0].currentFrame()].w * PARAMS.CHUNLI;
//                                 if(that.state === 4) that.x = entity.BB.left - that.kick[that.animations[4][0].currentFrame()].w * PARAMS.CHUNLI;
...
//                             || entity instanceof Goku) && that.lastBB.right >= entity.BB.left){
//                                 if(that.state === 0) that.x = entity.BB.left - that.idle[that.animations[0][0].currentFrame()].w * PARAMS.CHUNLI;
//                                 if(that.state === 1) that.x = entity.BB.left - that.walk[that.animations[1][0].currentFrame()].w * PARAMS.CHUNLI;
//                                 if(that.CPUSTATE.AIR) that.x = entity.BB.left - that.jump[that.animations[2][0].currentFrame()].w * PARAMS.CHUNLI;
//                                 if(that.state === 3) that.x = entity.BB.left - that.punch[that.animations[3][0].currentFrame()].w * PARAMS.CHUNLI;  
//                                 if(that.state === 4) that.x = entity.BB.left - that.kick[that.animations[4][0].currentFrame()].w * PARAMS.CHUNLI;
//                                 if(that.state === 5) that.x = entity.BB.left - that.jKick[that.animations[5][0].currentFrame()].w * PARAMS.CHUNLI;
//                                 if(that.state === 6) that.x = entity.BB.left - that.sKick[that.animations[6][0].currentFrame()].w * PARAMS.CHUNLI;
//                                 if(that.state === 7) that.x = entity.BB.left - that.bKick[that.animations[7][0].currentFrame()].w * PARAMS.CHUNLI;  
//                                 if(that.state === 8) that.x = entity.BB.left - that.gHit[that.animations[8][0].currentFrame()].w * PARAMS.CHUNLI; 
//                                 if(that.state === 9) that.x = entity.BB.left - that.duck[that.animations[9][0].currentFrame()].w * PARAMS.CHUNLI;
//                                 if(that.state === 10) that.x = entity.BB.left  - that.blocked[that.animations[10][0].currentFrame()].w * PARAMS.CHUNLI;
//                         }
//                         if((entity instanceof KaratePlayer || entity instanceof catplayer || entity instanceof ChunLi || entity instanceof BillyLee
//                             || entity instanceof Goku) && that.lastBB.left <= entity.BB.right){
    ...
    update(){
        ...
        this.game.entities.forEach(function (entity) {
                if (that !== entity && entity.BB && that.BB.collide(entity.BB)) {
                    ...
                    if((entity instanceof KaratePlayer || entity instanceof catplayer || entity instanceof ChunLi || entity instanceof BillyLee 
                        || entity instanceof Goku) && that.lastBB.left <= entity.BB.right && that.position < 0){
                            if(that.CPUSTATE.WALK) that.x = entity.BB.right;
                            if(that.CPUSTATE.ATTACK)that.x = entity.BB.right;
                            that.CPUSTATE.ATTACK = true;
                            if(that.CPUSTATE.ATTACK === true){
                                if(that.attack === 0){
                    ...
                    if((entity instanceof KaratePlayer || entity instanceof catplayer || entity instanceof ChunLi || entity instanceof BillyLee 
                        || entity instanceof Goku) && that.lastBB.right >= entity.BB.left && that.position > 0){
                            console.log("does he enter?");
                            //if(that.CPUSTATE.WALK){
                                console.log("testing");
                ...
                if (that !== entity && entity.BB && that.BB.collide(entity.BB)) {
                    ...
                    if (that.velocity.y >= 0) {
                      ...
                      // if(that.state === 8) that.state = 0;           
                        ...
                        if((entity instanceof KaratePlayer || entity instanceof catplayer || entity instanceof ChunLi || entity instanceof BillyLee
                            || entity instanceof Goku) && that.lastBB.right >= entity.BB.left){
                            if(that.state === 0) that.x = entity.BB.left - that.idle[that.animations[0][0].currentFrame()].w * PARAMS.BL;
                            else if(that.state === 1) that.x = entity.BB.left - that.walk[that.animations[1][0].currentFrame()].w * PARAMS.BL;
                            else if(that.state === 2) that.x = entity.BB.left- that.rPunch[that.animations[2][0].currentFrame()].w * PARAMS.BL;
                            else if(that.state === 3) that.x = entity.BB.left - that.lPunch[that.animations[3][0].currentFrame()].w * PARAMS.BL;  
                            else if(that.state === 4) that.x = entity.BB.left - that.sPunch[that.animations[4][0].currentFrame()].w * PARAMS.BL;
                            else if(that.state === 5) that.x = entity.BB.left - that.kick[that.animations[5][0].currentFrame()].w * PARAMS.BL;
                            else if(that.state === 6) that.x = entity.BB.left - that.sKick[that.animations[6][0].currentFrame()].w * PARAMS.BL;
                            else if(that.state === 7) that.x = entity.BB.left - that.gHit[that.animations[7][0].currentFrame()].w * PARAMS.BL;  
                            else if(that.state === 8) that.x = entity.BB.left - that.jump[that.animations[8][0].currentFrame()].w * PARAMS.BL; 
                            else if(that.state === 9) that.x = entity.BB.left - that.duck[that.animations[9][0].currentFrame()].w * PARAMS.BL;
                            else if(that.state === 10) that.x = entity.BB.left - that.duck[that.animations[9][0].currentFrame()].w * PARAMS.BL;
                        }
                        if((entity instanceof KaratePlayer || entity instanceof catplayer || entity instanceof ChunLi || entity instanceof BillyLee
                            || entity instanceof Goku) && that.lastBB.left <= entity.BB.right){
                            that.x = entity.BB.right;
